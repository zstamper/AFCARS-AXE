...
Windows:
    ...
    C:> pyinstaller --clean --onefile --name AXE -w --icon=assets/favicon.ico --add-data "ui/style.qss;ui" --add-data "assets/pexels-negative-space-97077.jpg;assets" --add-data "ui/*.ui;ui" main.py
